namespace WinFormsApp1
{
    public class Shape
    {
        ...
        public virtual void moveShape(int dx, int dy, int pictBoxLeft, int pictBoxRight, int pictBoxTop, int pictBoxBottom)
        {
            ...
            if (this.check_move(dx, dy, pictBoxLeft, pictBoxRight, pictBoxTop, pictBoxBottom))
            {
                x = newX;
                y = newY;
            }
        ...
        public bool check(int pictureBoxLeft, int pictureBoxRight, int pictureBoxTop, int pictureBoxBottom)
        {
        ...
        public bool check_move(int dx, int dy, int pictureBoxLeft, int pictureBoxRight, int pictureBoxTop, int pictureBoxBottom)
        {
            if (rect.Left - dx >= pictureBoxLeft && rect.Right + dx <= pictureBoxRight && rect.Top - dy >= pictureBoxTop && rect.Bottom + dy <= pictureBoxBottom)
                return true;
            return false;
        }

        public virtual void change_size(int pictureBoxLeft, int pictureBoxRight, int pictureBoxTop, int pictureBoxBottom, bool setting)
        {
        ...
        public void change_size_ratio(bool setting, int pictureBoxLeft, int pictureBoxRight, int pictureBoxTop, int pictureBoxBottom)
        {
            
            if (setting)
            {
                size_ratio = 3;
                change_size(pictureBoxLeft, pictureBoxRight, pictureBoxTop, pictureBoxBottom, setting);
            }
            else if (!setting)
            {
                size_ratio = -3;
    ...
    public class CCircle : Shape
    {
        ...
        public override void change_size(int pictureBoxLeft, int pictureBoxRight, int pictureBoxTop, int pictureBoxBottom, bool setting)
        {
            ...
            {
                if (this.check(pictureBoxLeft, pictureBoxRight, pictureBoxTop, pictureBoxBottom))
                    radius += size_ratio;
    ...
    public class MyRectangle : Shape
    {
        ...
        public override void change_size(int pictBoxLeft, int pictBoxRight, int pictBoxTop, int pictBoxBottom, bool setting)
        {
            ...
            if (!setting && width >= 60 - size_ratio)
            {
                ...
                if (this.check(pictBoxLeft, pictBoxRight, pictBoxTop, pictBoxBottom))
                    {
                        width += size_ratio;
                        height += size_ratio;
                    }
